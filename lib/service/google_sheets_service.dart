...
class GoogleSheetsService {
  ...
  static const String _email = "congresso-terciarios@congressoterciarios.iam.gserviceaccount.com";
  static final String _credentials = r'''
  {
  ...
  '''
      .replaceFirst("email_address", _email);

  // Final
  // final _idSheets = "1DXXsXbGKvsex1d6UDj9mfMMAFYdH9CrmPQjLqdJJ9xc";
  // Prueba
  final _idSheets = "DPjObus0RQPUQbIOXHdZBniU0QmLcojy11d4FSNNc";
  ...
  Future<bool> _isMaster() async {
    ...
    var rows = await _worksheet?.cells.row(1);
    if(rows?.last.value.toUpperCase() == "@@MASTER@@"){
      return true;
    }
    return false;
  }
